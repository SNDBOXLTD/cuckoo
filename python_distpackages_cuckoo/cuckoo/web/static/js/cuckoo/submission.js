...
var submission_options = [{
	...
	name: 'enable-vnc',
	label: 'VNC mode',
	description: 'Enable remote connection to machine.',
	selected: true
}, {
	name: 'enable-kernelmode',
	label: 'Kernelmode analysis',
	description: 'Execute analysis with driver.',
	selected: true
}, {
